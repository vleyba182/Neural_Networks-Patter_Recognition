...
net.biases{3}.initFcn = 'rands';%bias values between 0,1
net.biases{4}.initFcn = 'rands';
net.inputweights{1}.initFcn='rands';
net.inputweights{2}.initFcn='rands';
net.inputweights{3}.initFcn='rands';
net.trainParam.lr = 0.1;
net.trainParam.epochs = 2500;
net.trainParam.max_fail = 2500;
[trainInd,valInd,testInd] = divideind(1600,800:1,1600:801,1600:801);
